...
export class PaymentMethodPage {
  ...
  isEditing: {
    [key in 'creditCard' | 'paypal' | 'gcash' | 'bankTransfer']: boolean;
  } = {
    creditCard: false,
    paypal: false,
    gcash: false,
  ...
  previousValues: {
    [key in 'creditCard' | 'paypal' | 'gcash' | 'bankTransfer']: string;
  } = {
    creditCard: '1',
    paypal: '2',
    gcash: '3',
  ...
  async toggleEdit(
    paymentMethod: 'creditCard' | 'paypal' | 'gcash' | 'bankTransfer'
  ) {
          ...
          buttons: [
            {
              ...
              handler: () => {
                ...
                this[`${paymentMethod}Number`] =
                  this.previousValues[paymentMethod];
